      ...
      try {
        ...
        if (facultyData && facultyData.program_id) {
          ...
          const yearLevelOneStudents = studentsResponse.data.filter(
            (student) => calculateYearLevel(student.student_number) === 3
          );
  ...
  const options = {
    ...
    labels:
      Array.isArray(studentsData) && studentsData.length > 0
        ...
        : [""], // Return an empty array if studentsList is not an array or is empty
  };
...
export default FailedPercentage3;
