...
import GradesperSemester from "../../../student/dashboard/analysis/GradesPerSem/gradesperSemester";
import GradesAverageLine from "../../../student/dashboard/analysis/GradesPerYear/gradesAverageLine";
...
function StudentAnalytics({ studentNumber, evalSemValue, evalYearValue }) {
  console.log("ee", evalSemValue, evalYearValue);
              ...
              <VStack>
                ...
                >
                  ...
                  <VStack spacing="3rem">
                    ...
                    <Spacer />
                    <Box alignItems="center" w="50rem" h="10rem" padding="1rem">
                      {latestGradeInfo ? (
                        <>
                        ...
                        <Text mt="5rem" fontWeight="semibold">
