...
function Evaluation() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (studentData) {
          ...
          setProgramId(studentData.program_id.toString());
        } else {
  ...
  //fetch evaluate
  useEffect(() => {
    console.log("Eval Year", parseInt(year));
    console.log("Eval Sem", semester);
    axios
      .get(
        `${endPoint}/evaluate-recommend?student_number=${studentNumber}&eval_year=${parseInt(
          year
        )}&eval_sem=${semester}`
      )
      .then((response) => {
        ...
        if (response.data.length > 0) {
          setFacultyId(response.data[0].faculty_number);
        ...
        <VStack mb="0" w="100%" justifyContent="center">
          ...
          <div ref={containerRef}>
            ...
            >
              ...
              >
                <Text
                  ...
                  fontWeight="semibold"
                  pl={{ base: "1.5rem", md: "6rem", lg: "17rem" }}
                >
                  Student Name:
                </Text>
                <Text>
                ...
                <Text w={{ base: "10rem", md: "6rem", lg: "10rem" }}>
                  ({studentNumber})
                </Text>
              </HStack>
              <HStack
                mb="4rem"
                ml={{ base: "1.5rem", md: "1rem", lg: "17rem" }}
              >
                <Text
                  fontWeight="semibold"
                  fontSize={{ base: "15px", md: "17.5px" }}
            ...
            <VStack>
                      ...
                      <Wrap mx="auto" spacing="3" w="70%" key={key}>
                        ...
                        >
                          ...
                          >
                            ...
                            <HStack w="13rem" ml={{ base: "", lg: "35rem" }}>
                              <Text
                                fontSize={{ base: "15px", md: "17.5px" }}
                                fontWeight="semibold"
                              >
              ...
              {evaluations.length !== 0 && (
                <Box
                  mr={{ base: "0.5rem", md: "6rem", lg: "40rem" }}
                  mt="5rem"
                  // mr="0.5rem"
                >
