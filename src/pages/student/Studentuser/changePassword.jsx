...
function ChangePassword({ isOpen, onClose }) {
  ...
  const handlePasswordChange = (e) => {
    ...
    setIsStrongPassword(checkPasswordStrength(newPassword));
  };
...
const handleSave = async () => {
  try {
    if (!oldpassword) {
      toast({
        title: "Warning",
        description: "Please fill in the old password field.",
        status: "warning",
        duration: 3000,
        isClosable: true,
        position: "top",
      ...
      <ModalContent>
        ...
        <ModalBody>
          <VStack>
            ...
            <Text fontSize="12px">
              Try combining numbers, big and small letters, and character for stronger password
            </Text>
            {isTyping && (
              <Text color={isStrongPassword ? "green" : "red"}>
