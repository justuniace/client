...
export default function GradesperSemester({
  ...
  const [ThirdYearSecondSemAverage, setThirdYearSecondSemAverage] = useState(0);
    const [ThirdYearSummerSemAverage, setThirdYearSummerSemAverage] =
      useState(0);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setSummerSem(filteredThirdYearSummerSemData);
        //compute
        const sumGradesThirdSummerSem = filteredThirdYearSummerSemData.reduce(
          (sum, grade) => sum + grade.grades,
          0
        );
        ...
        const averageGradeThirdSummerSem =
          filteredThirdYearSummerSemData.length > 0
            ? sumGradesThirdSummerSem / filteredThirdYearSummerSemData.length
            : 0;
