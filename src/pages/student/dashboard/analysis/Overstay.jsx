...
function Overstay({ studentNumber,  setCourses}) {
  ...
  const checkCoursesWithoutGrades = () => {
    ...
    setCourses(coursesWithoutGrades);
 ...
 const courseDetailsTable = coursesWithoutGradesFromPreviousYear.map((course) => ({
        ...
        coursesWithoutGradesFromPreviousYear.length > 0 && (
          ...
          >
            ...
            >
              ...
              <Tfoot h="2rem" bgColor="#F0EEED" colSpan="9" textAlign="center">
                <Tr>
                  <Th></Th>
                  <Th></Th>
                  <Th></Th>
