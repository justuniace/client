...
export default function NewStudentSignin() {
    ...
    try {
      ...
      if (matchedStudent) {
        if (matchedStudent.email !== email) {
          ...
          Cookies.set("student_number", student_number, {
            expires: 10,
          });
          ...
          console.log("Student number logged in and cookie:", student_number);
  ...
  const studentinputStyles = {
    ...
    textAlign: "left",
    paddingTop: "1rem",
    // width:"185%", //desktop screen
    // width: "185%",
    width: "100%", // Full width on small screens
    //maxWidth: "350px",

    // width: "218%", //mobile screen
