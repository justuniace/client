...
function Curriculum() {
  ...
  useEffect(() => {
    ...
    async function fetchStudentData() {
      try {
        ...
        const fetchedProgramId = studentData.program_id;
        setProgramId(fetchedProgramId);
        console.log("Student data fetched:", fetchedProgramId);
      } catch (error) {
    ...
    if (studentNumber) {
      // Ensure studentNumber is defined
      fetchStudentData();
    }
    ...
    const fetchProgramName = async () => {
      try {
        ...
        const matchedProgram = data.find(
          (programItem) =>
            programItem.program_id.toString() === programId.toString()
        );
          ...
          if (matchedProgram) {
            ...
            setProgAbbr(matchedProgram.program_abbr);
  ...
  useEffect(() => {
    ...
    fetchGradesData();
  }, [courseType, programId, studentNumber]);
  ...
  return (
    ...
    >
      ...
      <VStack mt={{ base: "-6", lg: "" }} mb="0" flexGrow={1} w="100%">
        <InputGroup mt="8rem" ml={{ base: "0", lg: "55rem" }} w="20rem">
          <Input
            p="1rem"
            fontFamily="inter"
        ...
        <div ref={containerRef}>
          <VStack>
            ...
            >
              <VStack mr={{ base: "0", md: "5rem", lg: "5rem" }} spacing={1}>
                <Text
                  mt={{ base: "2rem" }}
                  fontSize="19px"
                  fontWeight="bold"
                ...
                >
                  ...
                  <Text ml={{ base: "0", md: "3rem", lg: "auto" }} w="100%">
                    ( {studentData.student_number})
                  </Text>
                </Box>
              </VStack>
              <Button
                ml={{ base: "25rem", md: "35rem", lg: "auto" }}
                mr={{ base: "auto", md: "0", lg: "0" }}
                mt={{ base: "-55", md: "1rem", lg: "auto" }}
